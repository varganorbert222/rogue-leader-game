...
export function mergeControlBindings(
  ...
  return {
    ...
    cameraDistance: mergeAxisAction(defaults.cameraDistance, patch.cameraDistance),
    ...
    fireSecondary: mergeButtonAction(defaults.fireSecondary, patch.fireSecondary),
    ...
    gamepad: {
      ...
      rightStick: { ...defaults.gamepad.rightStick, ...patch.gamepad?.rightStick },
