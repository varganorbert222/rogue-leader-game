...
- [ ] `models/props/asteroid/asteroid_01.glb` … `asteroid_05.glb` (list every variant in manifest)

```json
"asteroid": {
  "variants": [
    "models/props/asteroid/asteroid_01.glb",
    "models/props/asteroid/asteroid_02.glb"
  ],
  "scale": [0.8, 2.5],
  "colliderRadius": 3.0
}
